$(document).ready(function () {
  ...
  $("#img1").mouseover(function(){
    ...
    // if you click mouseover down list team
    $("li").click(function(){
    ...
    $(".img").click(function () {
      ...
      // use my (id) API from football-data-org 
      $.ajax({
